 ...
 */
final class Version20251213075147 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id SERIAL NOT NULL, username VARCHAR(255) NOT NULL, phone_number VARCHAR(255) DEFAULT NULL, role VARCHAR(100) NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
